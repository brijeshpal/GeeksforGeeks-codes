<h2><a href="https://www.geeksforgeeks.org/problems/number-of-divisors1631/1?page=3&difficulty=School&sortBy=submissions">Number of divisors</a></h2><h3>Difficulty Level : Difficulty: School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given&nbsp;an integer <strong>N,</strong> find&nbsp;the number of divisors of N that are divisible by 3.</span><br>
&nbsp;</p>
